...
class RunningWorkoutViewModel(
    ...
    val session = RunningSession(context, preferencesManager, debugMode)
    ...
    fun saveWorkout(
        ...
        distance: Double,
        calories: Int,
        unitSystem: com.example.workoutbuddyapplication.ui.theme.UnitSystem,
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (user == null) {
                    _saveError.value = "Gebruiker niet ingelogd"
